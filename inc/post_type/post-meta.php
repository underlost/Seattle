...
function post_meta_boxes() {
  ...
  add_meta_box('post_meta_box', 'Page Settings', 'render_post_meta_box', 'page', 'side', 'high');
}

function render_post_meta_box($object, $box) {
  global $image_size_options;
  global $image_height_options;
  global $page_layout_options;
  ...
  ?>
    ...
    <p>
      ...
      <select name="display-img-size">
          <?php foreach ($page_layout_options as $key => $val) { ?>
    ...
    <p>
      <strong>Featured Image Width</strong>
      <br />
      <select name="display-img-size">
    ...
    <p>
      <strong>Featured Image Height</strong>
      <br />
...
function save_post_meta($post_id, $post) {
  ...
  $meta_keys = array('display-img-size', 'display-img-height', 'source-name', 'source-url', 'featured', 'nsfw', 'lightbox', 'location', 'layout', );
